...
public class Missatges {
    ...
    public static final String T_CLIENT_SET_NAME = "setName";
    public static final String T_NOU_PERFIL = "nouPerfil";
    public static final String T_PETICIO_SELECT = "PeticioSelect";
    public static final String T_COLOCAR_FITXA = "ColocarFitxa";
    public static final String T_INVITACIO = "invitacion";
    public static final String T_ACCEPT_INVITACIO = "acceptInvitation";
    ...
    public static final String CORRECTE = "correcte";
    public static final String WINNING_CELLS = "winningCells";
    public static final String CHALLENGER = "challenger";
    public static final String JUGADOR_1 = "jugador1";
    public static final String JUGADOR_2 = "jugador2";
    public static final String INVITED = "invited";

    public static final String RED = "RED";
    public static final String YELLOW = "YELLOW";
    public static final String ESTAT_DISPONIBLE = "Disponible";
    public static final String ESTAT_EN_PARTIDA = "en partida";
}
